...
<!-- OUTSTANDING:
- (will probably want starter code for the activities below)
- Create specs for Guided Practice: LinearLayout for popular app
- Create specs for Guided Practice: FrameLayout
- Provide more detailed specs and solution code for Independent Practice: Layouts
- The lesson as it stands now is over 1:30.  Consider removing the final guided practice or the final independent practice activity
-->
