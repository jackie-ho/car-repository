...
1. Checks
2. Guided Practice: Adding log statements - there should be more explicit directions here about where and what types of methods to call on the log class
3. Guided Practice: Adding toasts - again, there should be more explicit directions about where in the code we're going to be adding toast and what they should say
