...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null) {
            Toast.makeText(this,"RESTORING LIST",Toast.LENGTH_LONG).show();
            mToDoLists = savedInstanceState.getParcelableArrayList("toDoLists");
        } else {
...
//        }
    ...
    public void onSaveInstanceState(Bundle savedInstanceState) {
        savedInstanceState.putParcelableArrayList("toDoLists", mToDoLists);
    ...
    public void onSaveInstanceState(Bundle outState, PersistableBundle outPersistentState) {
        outState.putParcelableArrayList("toDoLists",mToDoLists);
